		...
		public UnityEngine.UI.InputField E_AccountInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_AccountInputField = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"Panel/E_Account");
     			}
		...
		public UnityEngine.UI.Image E_AccountImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_AccountImage = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Panel/E_Account");
     			}
		...
		public UnityEngine.UI.InputField E_PasswordInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PasswordInputField = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"Panel/E_Password");
     			}
		...
		public UnityEngine.UI.Image E_PasswordImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PasswordImage = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Panel/E_Password");
     			}
		...
		public UnityEngine.UI.Button E_LoginBtnButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_LoginBtnButton = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Panel/E_LoginBtn");
     			}
		...
		public UnityEngine.UI.Image E_LoginBtnImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_LoginBtnImage = EUI.UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Panel/E_LoginBtn");
     			}
