...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForSubUI(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + $"{CodeRootPath}/HotfixView/{UIRootFolder}/UIBehaviour/CommonUI" +
                             "";
        ...
        strFilePath     = Application.dataPath + $"{CodeRootPath}/HotfixView/{UIRootFolder}/UIBehaviour/CommonUI/" + strDlgName + "ViewSystem.cs";
    ...
    static void SpawnCodeForSubUIBehaviour(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + $"{CodeRootPath}/ModelView/{UIRootFolder}/UIBehaviour/CommonUI";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + $"{CodeRootPath}/ModelView/{UIRootFolder}/UIBehaviour/CommonUI/" + strDlgName + ".cs";
